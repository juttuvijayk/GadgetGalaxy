        ...
        <div className="my-18 text-sm text-slate-600">
                            ...
                            <div>
                                <div className="flex items-center" >
                                    {Array(5).fill('').map((_, index) => (
                                        <StarIcon key={index} size={18} className='text-transparent mt-0.5' fill={item.rating >= index + 1 ? "#FFB224" : "#D1D5DB"} />
                                    ))}
                                </div>
            ...
            <div className="flex gap-3 mt-14">
                ...
                <div>
                    ...
                    <Link href={`/shop/${product.store.username}`} className="flex items-center gap-1.5 text-red-600"> view store <ArrowRight size={14} /></Link>
                </div>
            </div>
        </div>
    )
