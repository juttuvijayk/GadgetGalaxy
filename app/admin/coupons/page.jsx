    ...
    return (
        <div className="text-slate-500 mb-40">
            ...
            <form onSubmit={(e) => toast.promise(handleAddCoupon(e), { loading: "Adding coupon..." })} className="max-w-sm text-sm">
                ...
                <div className="mt-5">
                    <div className="flex gap-2 mt-3">
                        <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                            ...
                            />
                            <div className="w-11 h-6 bg-slate-300 rounded-full peer peer-checked:bg-cyan-600 transition-colors duration-200"></div>
                ...
                <button className="mt-4 p-2.5 px-10 rounded font-semibold bg-indigo-600 text-white hover:bg-indigo-700 active:scale-95 shadow-md shadow-indigo-600/10 transition">Add Coupon</button>
            </form>
