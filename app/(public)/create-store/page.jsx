                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Submitting data..." })} className="max-w-7xl mx-auto flex flex-col items-start gap-3 text-slate-500">
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">To become a seller on GadgetGalaxy, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
                        ...
                        <button className="bg-cyan-600 text-white px-12 py-2.5 rounded font-semibold mt-10 mb-40 active:scale-95 hover:bg-cyan-700 shadow-md shadow-cyan-600/10 transition ">Submit</button>
                    </form>
                </div>
            ) : (
